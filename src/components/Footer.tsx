        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://www.theislam360.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
                  Islam360 (Parent App)
                </a>
              </li>
            </ul>
