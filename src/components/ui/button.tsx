  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-gold-bright to-gold-warm text-purple-deep font-extrabold shadow-glow-gold hover:shadow-[0_0_50px_hsl(45_95%_55%/0.7)] hover:scale-105",
        heroOutline: "border-2 border-foreground/80 bg-transparent text-foreground hover:bg-foreground/10 hover:border-foreground",
        // Accent green button
        accent: "bg-accent text-accent-foreground hover:bg-green-light hover:scale-105 shadow-lg",
      },
      size: {
